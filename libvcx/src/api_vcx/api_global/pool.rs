...
use aries_vcx::{
    global::settings::{indy_mocks_enabled, DEFAULT_POOL_NAME},
    indy::ledger::pool::{close, create_pool_ledger_config, open_pool_ledger, PoolConfig},
    vdrtools::INVALID_POOL_HANDLE,
};
...
pub mod tests {
    use aries_vcx::{
        global::settings::{set_config_value, CONFIG_GENESIS_PATH},
        indy::ledger::pool::{
    ...
    use crate::{
        api_c::vcx::vcx_open_main_pool,
        api_vcx::api_global::pool::{get_main_pool_handle, open_main_pool, reset_main_pool_handle},
